...
<?php 
		...
		echo "<a href='https://xampp-ecom-store.herokuapp.com/myshop/customer/my_account.php'>Go to your Account</a>";
		
		}
		else {
		
		echo "<h2>Welcome Guest, Payment was failed</h2><br>";
		echo "<a href='https://xampp-ecom-store.herokuapp.com/myshop'>Go to Back to shop</a>";
			...
			$headers .= 'From: <i.am.teralian@gmail.com>' . "\r\n";
			...
			Hello dear <b style='color:blue;'>$c_name</b> you have ordered some products on our website, please find your order details, your order will be processed shortly. Thank you!</p>
			
				<table width='600' align='center' bgcolor='#FFCC99' border='2'>
			
					<tr align='center'><td colspan='6'><h2>Your Order Details from DVN Shop</h2></td></tr>
				...
				<h2> <a href='https://xampp-ecom-store.herokuapp.com/myshop'>Click here</a> to login to your account</h2>
				
				<h3> Thank you for your order at DVN Shop</h3>
